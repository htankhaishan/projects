...
const ProjectCardInProcess = ({ imgUrl, title, description, gitUrl }) => {
  return (
    <div>
      <div
        className="h-72 md:h-96 rounded-t-xl relative group center center bg-no-repeat"
        style={{
          background: `url(${imgUrl})`,
          backgroundSize: "cover", // Fit and cover the image
...
export default ProjectCardInProcess;
